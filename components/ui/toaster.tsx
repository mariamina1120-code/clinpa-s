...
// Simple inline toast state (no external hook file needed)
const TOAST_LIMIT = 5;
...
export { Toaster, useToast, Toast, ToastAction, ToastClose, ToastDescription, ToastProvider, ToastTitle, ToastViewport };
